"""
Django settings for ihmBack project.
...
SECRET_KEY = 'django-insecure-c%(d(s%wk5fqn3@%bksd^l^px_g^-8hg77u@(vd=qtfmwp0qj4'
...
WSGI_APPLICATION = 'ihmBack.wsgi.application'
